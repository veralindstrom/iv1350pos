...
public class Inventory {
    ...
    private final boolean connectedToInventoryDatabase = false;
    ...
    public ItemDTO fetchItem(int itemId) throws SQLException{
    ...
    private ItemDTO checkForMatchingItemInInventory(int itemId) throws InventoryException,
                                                                        SQLException {
        try{
            ItemDTO currentIterationItem = null;
            if(!connectedToInventoryDatabase)
            ...
            throw new InventoryException("Couldn't connect to database", sqle);
        }

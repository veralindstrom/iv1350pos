...
public class AmountTest {
    ...
    public void testMinusNegeativeResult() {
        ...
        Amount expResult = new Amount(amountOfOperand1 - amountOfOperand2);
        Amount result = operand1.minus(operand2);
        assertEquals("Wrong subtraction neg result", expResult.toString(), result.toString());
    }
    ...
    public void testMinusZeroResultNegativeOperand() {
        ...
        Amount expResult = new Amount(amountOfOperand1 - amountOfOperand2);
        Amount result = operand1.minus(operand2);
        assertEquals("Wrong neg subtraction result", expResult.toString(), result.toString());
    }
    ...
    public void testPlusNegeativeResult() {
        ...
        Amount expResult = new Amount(amountOfOperand1 + amountOfOperand2);
        Amount result = operand1.plus(operand2);
        assertEquals("Wrong addition neg result", expResult.toString(), result.toString());
    }
    ...
    public void testPlusZeroResultNegativeOperand() {
        ...
        Amount expResult = new Amount(amountOfOperand1 + amountOfOperand2);
        Amount result = operand1.plus(operand2);
        assertEquals("Wrong neg addition zero result", expResult.toString(), result.toString());
    }

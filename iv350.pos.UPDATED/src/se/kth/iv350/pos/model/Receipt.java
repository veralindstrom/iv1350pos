...
public class Receipt {
  ...
  */  
    ...
    private void appendPrices(){
        ...
        string.append( df2.format(priceInfo.getTotalPrice().minus(priceInfo.getTotalVatPrice()))).append("\n");
        
        string.append("Total VAT: ");
        string.append( df2.format(priceInfo.getTotalVatPrice())).append("\n");
        string.append("\nTotal price (incl. VAT): ");
        string.append( df2.format(priceInfo.getTotalPrice())).append("\n");
        
        string.append("\nAmount paid: ");
        string.append( df2.format(priceInfo.getAmountPaid()));
        string.append("\nChange: ");
        string.append( df2.format(priceInfo.getChange())).append("\n");
    }
